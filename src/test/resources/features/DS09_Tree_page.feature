...
Feature: Tree page DS_ALGO
  I want to use this template for my feature file
    ...
    When The user clicks on the Overview of Trees link
	  ...
	  @Tree002
	  Scenario: Validate "Terminologies"
	  ...
	  @Tree004
	  Scenario: Validate "Tree Traversals"
	  ...
	  @Tree007
	  Scenario: Validate "Types of Binary Trees"
	  ...
	  And User navigates back to Tree page
	   ...
	   @Tree011
	  Scenario: Validate "Application of Binary trees"
	  ...
	  @Tree012
	   Scenario: Validate "Binary search trees"
